...
function processForm() {
    ...
    second.innerHTML =
        "But surprise, surprise... Here we are, and everything just went downhill from there. It's like we're on completely different wavelengths. You never " + verb1 + " out the " + noun1 + " or " + verb2 + " the " + pluralNoun + ". And when I ask you if I look " + adjective + ", you just sort of stare at me... One time, you didn't even stare, you just went outside and started " + verbIng1 + " your " + bodyPart + "! Right in front of the neighbors, too! And that's only one of the many moments that you have embarassed me. But the most embarrassing moment of all was when I found out that you've been " + verbIng2 + " with my " + occupation + " behind my back. Oh, what? You thought I didn't know? Give me a break. Actually, no. Let me give you a break. A permanent one! Don't text me. Don't call me. Don't even speak my name... ";
